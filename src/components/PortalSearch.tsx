...
export default function PortalSearch() {
  ...
  return (
    <>
      ...
      >
        <div className="flex-1 px-6 py-3 border-b md:border-b-0 md:border-r border-stone-600 w-full group">
          <label className="text-[11px] md:text-sm font-bold uppercase tracking-wider text-rose-300 group-hover:text-rose-400 transition-colors pointer-events-none drop-shadow-sm">Cosa stai cercando?</label>
          <div className="w-full text-white font-bold text-xl pt-1 h-8 flex items-center drop-shadow-md">Es. Fotografo, Location, Catering...</div>
        </div>
        <div className="flex-1 px-6 py-3 border-b md:border-b-0 md:border-r border-stone-600 w-full group hidden md:block">
          <label className="text-[11px] md:text-sm font-bold uppercase tracking-wider text-rose-300 group-hover:text-rose-400 transition-colors pointer-events-none drop-shadow-sm">Dove?</label>
          <div className="w-full text-white font-bold text-xl pt-1 h-8 flex items-center drop-shadow-md">Es. Roma, Milano, Napoli...</div>
        </div>
